...
import { comfortScore, comfortBin, bestWindow, isMonthInWindow, formatBestSpan } from './seasonality.js';
...
test('best window wraps over the year seam', () => {
  ...
  assert.deepEqual(w, { startMonth: 10, endMonth: 1, peakMonth: 1, isWrap: true });
